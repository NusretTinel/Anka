<template>
  <div class="row" style="background-color: BLACK ; height: 10vh; ; width: 100%">
    ...
    <div class="col-lg-2">
      <div class="at">
        <svg height="75" viewBox="0 0 288.93 154.35" width="150" xmlns="http://www.w3.org/2000/svg">
          <defs>
    ...
    <div class="col-lg-2 ">
      <div class="row">
        <div class="col-lg-1 navbarItem ">
          <a href="tel:+905422572866" target="_blank">
            <i class="fas fa-phone navbarItem  "></i>
          </a>
        </div>
        <div class="col-lg-1 navbarItem">
          <a href="https://www.google.com/maps/dir/39.9245312,32.8237056/Yeni+Batı,+2401.+Sk.+No:10,+06370+Yenimahalle%2FAnkara/@39.9433593,32.589958,11z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x14d3364d993fb63b:0x10adcbcc312d295a!2m2!1d32.6854079!2d39.9778253?entry=ttu"
             target="_blank">
            <i class="fas fa-map-marker-alt navbarItem"></i>
          </a>
        </div>
        <div class="col-lg-1 navbarItem">
          <a href="mailto:info@ankatedarik.com" target="_blank">
            <i class="fas fa-envelope navbarItem"></i>
          </a>
